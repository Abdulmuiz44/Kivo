      ...
      class y extends i.default.Component {
        ...
        render() {
          ...
          P &&
            ...
            (P = O.concat(x)));
          let v = i.default.Children.toArray(this.props.children).filter(Boolean);
          ...
          let j = d(this.context.buildManifest, this.context.__NEXT_DATA__.page, o),
            R = (function (e, t, n = '') {
              ...
              o &&
                (0, r.jsxs)(r.Fragment, {
                  children: [
                    ...
                    !b &&
                      (0, r.jsx)('link', { rel: 'canonical', href: a + n(337).cleanAmpPath(u) }),
                    (0, r.jsx)('link', {
                      rel: 'preload',
                      as: 'script',
